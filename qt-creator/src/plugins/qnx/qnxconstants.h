...
const char QNX_SETTINGS_ID[] = "ZZ.Qnx Configurations";
const char QNX_SETTINGS_CATEGORY[] = "X.Qnx";
const char QNX_SETTINGS_TR_CATEGORY[] = QT_TRANSLATE_NOOP("BlackBerry", "BlackBerry");
const char QNX_SETTINGS_CATEGORY_ICON[] = ":/qnx/images/QtBlackBerry.png";
const char BB_TOOLCHAIN_ID[] = "Qt4ProjectManager.ToolChain.BlackBerry";
const char BBQT[] = "Qt4ProjectManager.QtVersion.BlackBerry";
